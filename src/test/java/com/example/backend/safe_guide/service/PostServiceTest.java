...
public class PostServiceTest {
    ...
    void 포스트_생성시_정상동작한다() {
        ...
        Assertions.assertDoesNotThrow(() -> postService.create(fixture.getUserId(), fixture.getTitle(), fixture.getBody()));
    }
    ...
    void 포스트생성시_유저가_존재하지_않으면_에러를_내뱉는다() {
        ...
        when(postEntityRepository.save(any())).thenReturn(mock(PostEntity.class));
        SafeGuideApplicationException exception = Assertions.assertThrows(SafeGuideApplicationException.class, () -> postService.create(fixture.getUserId(), fixture.getTitle(), fixture.getBody()));
    ...
    void 포스트_수정시_포스트가_존재하지_않으면_에러를_내뱉는다() {
        ...
        SafeGuideApplicationException exception = Assertions.assertThrows(SafeGuideApplicationException.class, () ->
                postService.modify(fixture.getIdToken(), fixture.getPostId(), fixture.getTitle(), fixture.getBody()));
    ...
    void 포스트_수정시_유저가_존재하지_않으면_에러를_내뱉는다() {
        ...
        when(userEntityRepository.findByUserId(fixture.getUserId())).thenReturn(Optional.empty());
        SafeGuideApplicationException exception = Assertions.assertThrows(SafeGuideApplicationException.class, () -> postService.modify(fixture.getIdToken(), fixture.getPostId(), fixture.getTitle(), fixture.getBody()));
        Assertions.assertEquals(ErrorCode.USER_NOT_FOUND, exception.getErrorCode());
    }
    ...
    void 포스트_수정시_포스트_작성자와_유저가_일치하지_않으면_에러를_내뱉는다() {
        ...
        when(userEntityRepository.findByUserId(fixture.getUserId())).thenReturn(Optional.of(mockUserEntity));
    ...
    void 포스트_삭제시_포스트가_존재하지_않으면_에러를_내뱉는다() {
        TestInfoFixture.TestInfo fixture = TestInfoFixture.get();
        when(postEntityRepository.findById(fixture.getPostId())).thenReturn(Optional.empty());
        SafeGuideApplicationException exception = Assertions.assertThrows(SafeGuideApplicationException.class, () -> postService.delete(fixture.getIdToken(), fixture.getPostId()));
        Assertions.assertEquals(ErrorCode.POST_NOT_FOUND, exception.getErrorCode());
    }
    ...
    void 내_포스트리스트를_가져올_유저가_존재하지_않으면_에러를_내뱉는다() {
        TestInfoFixture.TestInfo fixture = TestInfoFixture.get();
        when(userEntityRepository.findByUserId(fixture.getUserId())).thenReturn(Optional.empty());
        SafeGuideApplicationException exception = Assertions.assertThrows(SafeGuideApplicationException.class, () -> postService.my(fixture.getIdToken(), mock(Pageable.class)));
    ...
    void 내포스트목록요청이_성공한경우() {
        TestInfoFixture.TestInfo fixture = TestInfoFixture.get();
        Pageable pageable = mock(Pageable.class);
        when(postEntityRepository.findAllByUserUserId(any(), pageable)).thenReturn(Page.empty());
        Assertions.assertDoesNotThrow(() -> postService.my(fixture.getIdToken(), pageable));
    }
}
